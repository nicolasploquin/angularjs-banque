...
if(!localStorage.test){
	window.localStorage.setItem("test", angular.toJson(1234));
}

console.log(angular.fromJson(localStorage["test"])+5);

	localStorage.setItem("message", "sdfqsdfqsdfqsdf");

	localStorage.message = " nouveau message";
*/

localStorage.banque_ng = localStorage.banque_ng ||
angular.toJson({"clients":[{
